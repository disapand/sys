...
//            && isset($request->rzsj) && isset($request->dwdz) && isset($request->dwdh) && isset($request->rzxs) &&isset($request->zsr)
            ...
            lxrxx::create([
                ...
                'lxdh' => $request -> lxdh,
                'sfzh' => $request -> sfzh,
                'lxrjzdz' => $request->lxrjzdz,
                'lxrgzdw' => $request->lxrgzdw,
                'dk' => $request -> dk,
                'lxr2' => $request -> lxr2,
                'gx2' => $request -> gx2,
                'lxdh2' => $request -> lxdh2,
                'sfzh2' => $request -> sfzh2,
                'lxrjzdz2' => $request->lxrjzdz2,
                'lxrgzdw2' => $request->lxrgzdw2,
                'dk2' => $request -> dk2,
                'lxr3' => $request -> lxr3,
                'gx3' => $request -> gx3,
                'lxdh3' => $request -> lxdh3,
                'sfzh3' => $request -> sfzh3,
                'lxrjzdz3' => $request->lxrjzdz3,
                'lxrgzdw3' => $request->lxrgzdw3,
                'dk3' => $request -> dk3,
                'lxr4' => $request -> lxr4,
                'gx4' => $request -> gx4,
                'lxdh4' => $request -> lxdh4,
                'sfzh4' => $request -> sfzh4,
                'lxrjzdz4' => $request->lxrjzdz4,
                'lxrgzdw4' => $request->lxrgzdw4,
                'dk4' => $request -> dk4,
            ]);
            qtxx::create([
                'jbxx_id' => $tmp -> id,
