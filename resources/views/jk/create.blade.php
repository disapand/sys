            ...
            <el-card class="box-card">
                ...
                <el-form ref="jk" label-width="80px" :model="jk" :rules="jkRules" size="mini">
                    ...
                    <el-form-item label="借款人" prop="jbxx_id">
                        <el-select v-model="jk.jbxx_id" placeholder="请选择借款人" style="width: 100%" filterable>
                            <el-option
                                    v-for="item in jkr_list"
                                    :key="item.id"
                                    :label="item.name"
                                    :value="item.id">
                            </el-option>
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="onSubmitPost('{{ route('jkCreate') }}', jk, 'jk')">确认提交</el-button>
                    </el-form-item>
